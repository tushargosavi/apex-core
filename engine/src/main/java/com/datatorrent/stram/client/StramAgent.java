 ...
 * @since 0.3.3
 */
public abstract class StramAgent extends FSAgent
{
  protected static final int MAX_REDIRECTS = 5;
  private static final int STRAM_WEBSERVICE_RETRIES = 1;

  protected static class StramWebServicesInfo
  {
    public StramWebServicesInfo(String appMasterTrackingUrl, String version, String appPath, String user, String secToken, JSONObject permissionsInfo)
    {
  ...
  protected abstract StramWebServicesInfo retrieveWebServicesInfo(String appId);
