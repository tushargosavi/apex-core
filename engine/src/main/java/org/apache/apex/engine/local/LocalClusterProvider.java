...
import org.apache.apex.engine.local.cli.ApexCli;
import org.apache.apex.engine.local.client.StramAppLauncher;
 ...
 */
public class LocalClusterProvider implements ClusterProvider
{
  public LocalClusterProvider()
  {
    new Settings().init();
  }
