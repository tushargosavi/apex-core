...
public class StramMiniClusterTest
{
  ...
  public void testSetupShutdown() throws Exception
  {
    ...
    com.datatorrent.stram.StramClient client = ClusterProviderFactory.getProvider().getStramClient(yarnConf, dag);
    try {
      client.start();
  ...
  public void testWebService() throws Exception
  {
    ...
    com.datatorrent.stram.StramClient client = ClusterProviderFactory.getProvider().getStramClient(new Configuration(yarnCluster.getConfig()), createDAG(tb));
    try {
      client.start();
      client.startApplication();
      ...
      try {
        String methodName = "getApplicationReport";
        Method getNameMethod = client.getClass().getMethod(methodName);
        appReport = (ApplicationReport)getNameMethod.invoke(client); // explicit cast
  ...
  public void testOperatorFailureRecovery() throws Exception
  {
    ...
    try {
      ...
      try {
        String methodName = "getApplicationReport";
        Method getNameMethod = client.getClass().getMethod(methodName);
        ar = (ApplicationReport)getNameMethod.invoke(client); // explicit cast
      } catch (ReflectiveOperationException e) {
        Assert.fail(e.getMessage());
      }

      assertEquals("should fail", FinalApplicationStatus.FAILED, ar.getFinalApplicationStatus());
  ...
  public void testUnmanagedAM() throws Exception
  {
    ...
    new InlineAM(conf)
    {
      ...
      public void runAM(ApplicationAttemptId attemptId) throws Exception
      {
        ...
        ApplicationMasterProtocol resourceManager = connectToRM();
...
*/
  ...
  private static ApplicationMasterProtocol connectToRM()
  {
    ...
    return ((ApplicationMasterProtocol)YarnRPC.create(conf).getProxy(ApplicationMasterProtocol.class, rmAddress, conf));
  }
...
*/
  ...
  public void testAddAttributeToArgs() throws Exception
  {
    ...
    StramClient client = ClusterProviderFactory.getProvider().getStramClient(conf, dag);
    try {
      client.start();
      client.startApplication();
