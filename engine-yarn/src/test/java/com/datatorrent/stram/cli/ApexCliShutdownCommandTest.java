...
/**
 * TODO:- Change to org.apache.apex namespace when the base Cli class namespace is changed to it
 */
@PowerMockIgnore({
    "javax.net.ssl.*",
    "org.apache.log4j.*"
    })
@PrepareForTest({YarnClient.class, org.apache.apex.engine.yarn.cli.ApexCli.class, StramAgent.class})
public class ApexCliShutdownCommandTest
{
  ...
  public void shutdownAppCommandUsesBestEffortApproach() throws Exception
  {
    ...
    ApexCli cliUnderTest = new org.apache.apex.engine.yarn.cli.ApexCli();
