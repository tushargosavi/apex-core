...
public class YarnAppLauncherImpl extends YarnAppLauncher<YarnAppLauncherImpl.YarnAppHandleImpl>
{
  ...
  static {
    propMapping.put(YarnAppLauncher.LIB_JARS, com.datatorrent.stram.client.StramAppLauncher.LIBJARS_CONF_KEY_NAME);
    propMapping.put(YarnAppLauncher.ORIGINAL_APP_ID, com.datatorrent.stram.client.StramAppLauncher.ORIGINAL_APP_ID);
    propMapping.put(YarnAppLauncher.QUEUE_NAME, com.datatorrent.stram.client.StramAppLauncher.QUEUE_NAME);
  }
  ...
  public YarnAppHandleImpl launchApp(final StreamingApplication app, Configuration conf, Attribute.AttributeMap launchParameters) throws LauncherException
  {
    ...
    try {
      ...
      com.datatorrent.stram.client.StramAppLauncher appLauncher = ClusterProviderFactory.getProvider().getStramAppLauncher(name, conf);
      ...
      ApplicationId appId = ((StramAppLauncher)appLauncher).launchApp(appFactory);
